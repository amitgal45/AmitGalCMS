...
@Input() slide:Array<any>=new Array<any>({name:'החליפות המושלמות לגבר',description:'מבצעים עד סוף מרץ על כל החליפות לגבר',model:'מבצעים',url:"/assets/slider/slide-img1.jpg"},
